...
// Tests compile to nothing when DOCTEST_CONFIG_DISABLE is defined
...
**CMake handling:**
- `CALCULATOR_ENABLE_TEST=OFF`: Defines `DOCTEST_CONFIG_DISABLE`, tests compile to nothing
- `CALCULATOR_ENABLE_TEST=ON`: Tests are compiled and run via CTest
