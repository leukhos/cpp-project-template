...
int Calculator::subtract(int firstValue, int secondValue) { return firstValue - secondValue; }

int Calculator::multiply(int firstValue, int secondValue) { return firstValue * secondValue; }
